...
- IV: `techniques/01_core_econometrics.md` Section 4
- Matching: `techniques/01_core_econometrics.md` Section 5
- Synthetic Control: `techniques/03_synthetic_control.md`
