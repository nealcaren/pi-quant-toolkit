...
| `09_plausibility_checks.md` | Per-stage sanity checks, confirm/overturn across specs, red-flag catalog |
| `10_handoff_audit.md` | Per-stage reproducibility gate, handoff audit, final clean-room check |
